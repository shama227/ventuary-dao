...
Object(_navbar__WEBPACK_IMPORTED_MODULE_2__["default"])(smoothScrollMoment);
var nGS;
...
$(document).on({
  mouseenter: invitesActive // click: invitesActive
...
function markDynamic() {
  ...
  var instanceTimeout;
  var durationDefault = 1.6;
  var randomDurationStart = 1.2;
  var randomDurationEnd = durationDefault;

  function calcWorker() {
    var duration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : durationDefault;
    var delay = 0;
    $marks.each(function (i) {
      ...
      if (i > 1) {
        var r = randomIntFromInterval(9, 15) / 10;
        delay -= r;
      }
...
__webpack_require__(/*! /Volumes/HDD/PHPStormProjects/ventuary-dao/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /Volumes/HDD/PHPStormProjects/ventuary-dao/src/sass/app.scss */"./src/sass/app.scss");
